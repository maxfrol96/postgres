...
-- 3. сколько дней в среднем уходит на доставку товара в Германию (таблица orders, колонки order_date, shipped_date, ship_country)se
select avg(shipped_date - order_date) as avg_ship_time from orders where ship_country = 'Germany'
